if (self.camera_modified) {
	...
	var camera_x_old = camera_get_view_x(camera_id)
	var camera_y_old = camera_get_view_y(camera_id)
	var camera_width_old = camera_get_view_width(camera_id)
	var camera_height_old = camera_get_view_height(camera_id)

	var camera_x_offset = camera_x_old + ((camera_width_old / 2) - (camera_width_scaled / 2))
	var camera_y_offset = camera_y_old + ((camera_height_old / 2) - (camera_height_scaled / 2))
