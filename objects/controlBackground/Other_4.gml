...
for (var temp_y = 0; temp_y <= room_maxx; temp_y += sprite_size) {
	for (var temp_x = 0; temp_x <= room_maxy; temp_x += sprite_size) {
		...
		draw_sprite(sprite_coin_flip, sprite_choose, temp_x, temp_y)
	}
}
